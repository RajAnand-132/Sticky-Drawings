...
editor.modal = {
  about: new MD.Modal({
    html: `
      ...
      <p>Sticky Drawings is a simple vector drawing application.</p>
      <p>At this time (2022), The author (<a href="http://rajanand-132.github.io/Portfolio/">Raj Anand</a>) is working on improving stability and improving the codebase, which contains a lot of legacy practices. The goal is to create a vector editor suitable for simple graphic design tasks.</p>
      `
  }),
  source: new MD.Modal({
    html: `
  ...
  donate: new MD.Modal({
    html: `
      <h1>Donate</h1>
      <p>
        Sticky Drawings relies on your generous donations for continued development.
